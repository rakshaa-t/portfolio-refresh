  ...
  return (
    <div className="relative w-full min-h-screen bg-[#D8D4E8] overflow-hidden">
      ...
      <div className="flex justify-center w-full mb-8" style={{ marginTop: '92px', paddingTop: '20px', paddingBottom: '100px' }}>
        ...
        >
          <svg width="341" height="220" viewBox="0 -10 341 220" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', display: 'block', pointerEvents: 'none' }}>
            <g filter="url(#filter0_ddddiiii_463_365)">
              ...
              <rect x="10.5" y="8.5" width="320" height="65" rx="17.5" stroke="url(#paint0_linear_463_365)" strokeWidth="3"/>
            </g>
            <defs>
              ...
              <clipPath id="clip0_463_365">
                <rect x="12" y="10" width="317" height="62" rx="16" fill="white"/>
              </clipPath>
            </defs>
          </svg>
        </div>
