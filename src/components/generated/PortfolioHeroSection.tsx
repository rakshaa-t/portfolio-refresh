      ...
      <div className="relative w-full p-6 md:p-11 mt-10 md:mt-[60px]">
        ...
        <div ref={cardsContainerRef} className="relative mx-auto w-full max-w-[348px] md:max-w-[90vw] lg:max-w-[1040.8px] lg:w-[1040.8px] lg:h-[485.6px]">
          ...
          <motion.div
            ...
            className="relative overflow-hidden w-full p-4 lg:absolute lg:overflow-hidden lg:z-20 lg:left-[203.2px] lg:top-[23.2px] lg:w-[603.2px] lg:h-[435.2px] lg:p-0"
            style={{
          ...
          <div className="relative h-full flex flex-col items-center">
            ...
            <div 
              className="absolute left-1/2 -translate-x-1/2 w-[calc(100%-32px)] max-w-[304px] md:max-w-[calc(90vw-32px)] lg:max-w-[560px] lg:w-[560px] top-0 h-[40px] pointer-events-none z-10"
              style={{
            ...
            <div 
              className="absolute left-1/2 -translate-x-1/2 top-[32px] flex flex-col w-[calc(100%-32px)] max-w-[304px] md:max-w-[calc(90vw-32px)] lg:max-w-[560px] lg:w-[560px] h-[320px] lg:h-[320px]"
            >
              <div 
            ...
            <div className="absolute left-1/2 -translate-x-1/2 flex flex-col items-center w-[calc(100%-32px)] max-w-[304px] md:max-w-[calc(90vw-32px)] lg:max-w-[560px] lg:w-[560px] bottom-[12px] gap-[8px] md:bottom-[20px] lg:bottom-[40px] md:gap-[10px] lg:gap-[12px]">
