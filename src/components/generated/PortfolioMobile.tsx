...
export const PortfolioMobile: React.FC<PortfolioMobileProps> = (props: PortfolioMobileProps) => {
  ...
  return (
    <div style={{width: '100%', minHeight: '100vh', position: 'relative', background: '#E3DDED', overflow: 'hidden'}}>
      ...
      {/* Header Bar */}
      <div style={{width: '100%', padding: 12, justifyContent: 'center', alignItems: 'center', gap: 200, display: 'inline-flex', position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50, background: 'rgba(227, 221, 237, 0.95)'}}>
      ...
      {/* Title Text */}
      <div style={{width: 364, padding: '0 38px', marginTop: 93, position: 'relative'}}>
      ...
      {/* Chat Component */}
      <div id="mobile-chat" style={{width: 388, height: 514, margin: '20px auto', position: 'relative', background: 'linear-gradient(180deg, #E9E8FF 0%, #EFF4EC 100%)', boxShadow: '0px 30px 66px rgba(0, 0, 0, 0.04)', overflow: 'hidden', borderRadius: 44, outline: '2px white solid', outlineOffset: '-2px'}}>
      ...
      <div style={{width: '100%', position: 'fixed', bottom: 0, left: 0, right: 0, padding: '16px 102px', background: 'rgba(255, 255, 255, 0.01)', backdropFilter: 'blur(1px)', zIndex: 50}}>
        <div style={{width: '100%', maxWidth: 236, margin: '0 auto', justifyContent: 'center', alignItems: 'flex-start', gap: 28, display: 'flex'}}>
          {/* Chat Button (Active) */}
          <div style={{flex: '1 1 0', height: 60, padding: 18, position: 'relative', background: '#283FE4', boxShadow: '1px 2px 4px rgba(0, 0, 0, 0.10)', overflow: 'hidden', borderRadius: 4444, outline: '1px white solid', justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="12" cy="12" r="7" stroke="white" strokeWidth="2" />
            </svg>
          </div>
          {/* Inbox Button */}
          <div style={{flex: '1 1 0', height: 60, padding: 18, background: 'rgba(255, 255, 255, 0.64)', borderRadius: 4444, justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button
            ...
            style={{flex: '1 1 0', height: 60, padding: 18, background: 'rgba(255, 255, 255, 0.64)', borderRadius: 4444, justifyContent: 'center', alignItems: 'center', display: 'flex', border: 'none', cursor: 'pointer'}}
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
