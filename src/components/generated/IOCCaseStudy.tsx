...
export const IOCCaseStudy: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-[#111111] overflow-x-hidden min-h-screen">
      {/* Background Blurs */}
      <div className="hidden lg:block absolute w-[1472px] h-[761px] left-1/2 -translate-x-1/2 top-[281px] bg-[#3a4a3c] rounded-[4444px] blur-[200px] pointer-events-none z-[-2]" />
      ...
      <div className="relative w-full px-4 md:px-6 lg:px-0 pt-24 md:pt-28 lg:pt-[194px] pb-20 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-sm md:text-base lg:text-[17px] font-light text-white/80 w-full leading-6 md:leading-7" style={{ fontFamily: 'Outfit, system-ui, sans-serif' }}>
            This was intense. Worked on it late 2024 through Doodleblue with Karthik and the IOC team. Their legacy vendor management system was a nightmare - a 29-page document with complex data and confusing workflows. Had to simplify it for 4 different user types who all needed to work together.
          </p>
        </motion.div>
          ...
          <div className="relative w-full border border-white rounded-lg" style={{ padding: '24px' }}>
            <div className="flex flex-col md:flex-row md:justify-between md:items-center pb-6 border-b border-white gap-2">
              ...
              <div className="text-base text-white md:text-right" style={{ fontFamily: 'Outfit, system-ui, sans-serif' }}>
                Understanding workflows for 4 user types (DO officer, engineer, vendor, contractor)
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-start py-6 border-b border-white gap-2">
              ...
              <div className="text-base text-white md:text-right md:max-w-[60%]" style={{ fontFamily: 'Outfit, system-ui, sans-serif' }}>
                Reorganizing 29 pages of complex data into manageable modules
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row md:justify-between md:items-center pt-6 gap-2">
              ...
              <div className="text-base text-white md:text-right md:max-w-[60%]" style={{ fontFamily: 'Outfit, system-ui, sans-serif' }}>
                Clean, enterprise-grade interfaces that work within rigid backend systems
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="text-sm md:text-base lg:text-[17px] font-light text-white/80 leading-6 md:leading-7 w-full" style={{ fontFamily: 'Outfit, system-ui, sans-serif' }}>
            ...
            <p>
              Working with enterprise clients like IOC means very little room for experimentation when you're dealing with government workflows. Rigid backend systems, strict compliance requirements, complex approval chains.
            </p>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-lg md:text-xl lg:text-[22px] font-bold text-white" style={{ fontFamily: 'Nexa, system-ui, sans-serif' }}>
            4 User Types, 1 System
          </h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
            {[
              { role: 'DO Officer', desc: 'Approvals & oversight' },
              { role: 'Engineer', desc: 'Technical specs & review' },
              { role: 'Vendor', desc: 'Submissions & tracking' },
              { role: 'Contractor', desc: 'Execution & reporting' }
            ].map((item, idx) => (
          ...
          <div className="flex flex-col gap-4 md:gap-5 w-full lg:w-[48%]">
            ...
            <div className="bg-[#111111] border border-white rounded-lg p-6 md:p-7 w-full h-full">
              <ul className="text-sm md:text-base font-light text-white/80 leading-6 md:leading-7 list-disc pl-6" style={{ fontFamily: 'Outfit, system-ui, sans-serif' }}>
                <li>Map each role's actual workflows</li>
                <li>Identify where old system creates friction</li>
                <li>Reorganize without removing features</li>
                <li>Work within backend constraints</li>
              </ul>
            </div>
          </div>
          <div className="flex flex-col gap-4 md:gap-5 w-full lg:w-[48%]">
            ...
            <div className="bg-[#111111] border border-white rounded-lg p-6 md:p-8 w-full h-full">
              <p className="text-sm md:text-base font-light text-white/80 leading-6 md:leading-7" style={{ fontFamily: 'Outfit, system-ui, sans-serif' }}>
                Unlike consumer products, enterprise design means balancing user needs with rigid backend systems. There's very little room for "move fast and break things" when dealing with government workflows.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
            {[
              {
                title: 'Simplicity ≠ Fewer Features',
                desc: 'Sometimes making something "simple" means reorganizing complexity, not removing it.'
              },
              {
                title: 'Multi-Role Design',
                desc: 'When 4 different roles use one system, you can\'t optimize for just one. Each needs their own optimized experience.'
              },
              {
                title: 'Legacy Constraints',
                desc: 'Working within existing backend limitations requires creative problem-solving and compromise.'
              },
              {
                title: 'Government Workflows',
                desc: 'Strict compliance, approval chains, and audit trails shape every design decision. No shortcuts.'
              }
            ].map((item, idx) => (
