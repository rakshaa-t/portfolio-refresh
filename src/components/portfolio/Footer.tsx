      ...
      <div className="container-main">
        ...
        <div className="flex flex-wrap gap-6 mb-12">
          {socialLinks.map((link) => (
            <a
              ...
              className="flex items-center gap-2 text-foreground-secondary hover:text-accent transition-colors group"
            >
        ...
        <div className="pt-8 border-t border-border">
          ...
          <p className="text-foreground-secondary text-sm mt-2">
            designed & built by <span className="text-accent">raksha</span> © {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
